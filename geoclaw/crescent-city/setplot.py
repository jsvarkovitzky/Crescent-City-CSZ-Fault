...
try:
    realGauge = loadtxt('19750_notide.txt',skiprows=1)
except:
    print "***"
    print "*** Did not find gauge file in 19750_notide.txt"
    print "***"
...
#       pylab.text(138.2,35.9,'Tokyo',color='w',fontsize=25)
    ...
    plotaxes.title = 'Surface'
    plotaxes.scaled = True
    plotaxes.xlimits = [234.75,236.12]
...
#       pylab.text(138.2,35.9,'Tokyo',color='w',fontsize=25)
    ...
    # Plot actual tide gauge data 
    plotitem = plotaxes.new_plotitem(plot_type='1d_plot')
    plotitem.plot_var = 4
    pylab.plot(realGauge[:,0],realGauge[:,1],'r')
